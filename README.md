...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-liberu-executive-insights-livewire?sort=semver)](https://github.com/liberusoftware/module-liberu-executive-insights-livewire/releases/latest) [![Tests](https://github.com/liberusoftware/module-liberu-executive-insights-livewire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-liberu-executive-insights-livewire/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-liberu-executive-insights-livewire
```
...
<a href="https://github.com/liberusoftware/module-liberu-executive-insights-livewire/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-liberu-executive-insights-livewire" alt="Contributors to liberusoftware/module-liberu-executive-insights-livewire">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-liberu-executive-insights-livewire/graphs/contributors).
